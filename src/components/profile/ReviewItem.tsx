...
export default function ReviewItem({
  ...
  return (
    <>
      <div className="mb-8" data-cy="comment-item">
        <div className="flex gap-6">
          ...
          <div className="flex-1 flex flex-col w-64">
            ...
            <div className="mb-2">
              {/* 판매자 및 상품 정보 */}
              <div className="mb-1 text-sub-gray" data-cy="seller-name">{sellerName} 님의 상품</div>
              <h3 className="text-xl font-medium mb-1" data-cy="project-name">{projectName}</h3>
            </div>

            <div className="flex items-center gap-4 mb-2">
              <div className="text-gray-500" data-cy="review-date">{reviewDate} 에 작성</div>
            ...
            >
              <div className="overflow-hidden">
                <p className="line-clamp-4 text-gray-700 whitespace-pre-wrap break-words" data-cy="review-content">{reviewContent}</p>
              </div>
            </button>
          </div>
        </div>
