...
import EditorPicksSkeleton from "./EditorPicksSkeleton"

function EditorPicksComponent({ projects }: {projects: MainProject[]}) {
...
const EditorPicks = dynamic(
  () => Promise.resolve(({ projects }: { projects: MainProject[] }) => {
    return (
      <EditorPicksComponent projects={projects} />
    )
  }),
  {
    ssr: false,
